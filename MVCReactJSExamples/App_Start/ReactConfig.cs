...
[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(ReactJSExamples.ReactConfig), "Configure")]
...
namespace ReactJSExamples
{
	public static class ReactConfig
	{
		public static void Configure()
		{
			...
			// 	.AddScript("~/Scripts/reactjscomponent/ButtonComponent.jsx")
			// 	.AddScript("~/Scripts/reactjscomponent/ProductTableComponent.jsx");
		}
	}
}